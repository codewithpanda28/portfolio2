...
export default function Home() {
  return (
    <div className="min-h-screen">
      <section className="max-w-6xl mx-auto px-4 py-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <div className="inline-block px-3 py-1 bg-purple-400/10 text-purple-400 rounded-full">
              Welcome to my portfolio
            </div>
            <h1 className="text-4xl lg:text-6xl font-bold">
              I am a <span className="text-purple-400">web developer</span> and
              <br />
              frontend designer
            </h1>
            <p className="text-gray-400 max-w-lg">
              Passionate about creating beautiful and functional web experiences. I specialize in
      ...
      <footer className="bg-gray-800/50 mt-20">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link href="/skills" className="text-gray-400 hover:text-purple-400 transition-colors">Skills</Link></li>
